...
<div id="page-wrap">
    ...
    <header id="header" class="header">
      ...
      <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            <li class="menu-item-has-children"><a href="#">This Month</a>

                            <ul class="sub-menu">
                            <li><a href="#">Home Work Assignments</a></li>
                            <li><a href="video_solution.html">Video Solutions</a></li>
                            <li><a href="topic_explation.html">Topic Explanations</a></li>
                            </ul>
                            </li>
                            <li  class="menu-item-has-children" ><a href="#">Past Month</a>
      ...
      <li>
                        ...
                        <a href="<?php echo  base_url('TutorController/Assignment'); ?>">Assignments</a>                    </li>
 ...
 <li>
              ...
              <!--<li class="menu-item-has-children">
                        <a href="dashboard/index.html">Departments List</a>
                        <ul class="sub-menu">
                            <li><a href="dashboard/index.html">Physics</a></li>
